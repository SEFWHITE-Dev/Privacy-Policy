...
Locally stored data will be deleted automatically from the device upon uninstallation of DodgeBit.

DodgeBit does not collect any data regarding the user except for Ad-mob analytics.
